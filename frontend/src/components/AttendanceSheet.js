        ...
        return (
            <div className={classes.root}>
                <header className={classes.header}>
                    <p  style={{width : "auto" ,color: "#18435a", fontSize: "35px", fontFamily: "roboto", borderBottom: "1px solid #18435a", margin: "20px", padding: "40px"}}>Feuille d'appel</p>
                    <ControlsBlock discard={this.props.discard}/>
                </header>
